...
/**
 * When stamp duty falls due, and what happens if it does not.
 *
 * The competitor calculator says "Stamp Duty must be paid within 14 days of
 * signing the S&P". That is correct and it is half the rule. It leaves out the
 * thirty-day limb, which is the one a foreign buyer needs, and it leaves out
 * the penalties entirely — and the penalty is the part that changes behaviour:
 * miss three months and it is four times the duty, which on a S$1.5m purchase
 * is not a late fee, it is a catastrophe.
 *
 * s 47 is the detail everyone gets wrong by a day: the period starts on the day
 * AFTER execution, not the day of.
 *
 * Source: Stamp Duties Act 1929, ss 42, 43, 46(1) and 47.
 * https://sso.agc.gov.sg/Act/SDA1929?ProvIds=P16-
 * Read against the version current as at 31 Aug 2026.
 */
export const STAMPING = {
  source: 'Stamp Duties Act 1929, ss 42, 43, 46(1) and 47',
  url: 'https://sso.agc.gov.sg/Act/SDA1929?ProvIds=P16-',
  versionAsAt: '2026-08-31',
  withinDaysInSingapore: 14,
  withinDaysAbroad: 30,
  clockStarts: 'the day after the instrument is first executed (s 47)',
  penalties: [
    { after: 'within 3 months', rule: 'the duty plus a penalty of $10 or the deficient duty, whichever is greater' },
    { after: 'after 3 months', rule: 'the duty plus a penalty of $25 or FOUR TIMES the deficient duty, whichever is greater' },
  ],
};
