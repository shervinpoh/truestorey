...
import { LTV, LTV_REVIEWED, MORTGAGE_DUTY, TENURE_CAP, TENURE_AGE_LIMIT, TDSR_LIMIT, MSR_LIMIT, STRESS_TEST_RATE } from './constants.js';
...
export function plan({
  ...
  const cashFloor = Math.ceil(price * ltv.cashMin);
  ...
  return {
    ...
    assumptions: {
      ...
      msrLimit: propertyType === 'HDB' ? MSR_LIMIT : null,
