...
/** Reported separately from the funnel: a tool run is not a step towards a
 *  lead, and lining it up as one would make the funnel read as leakier than
 *  it is every time somebody used a calculator and left satisfied. */
export const TOOL_USE = { key: EVENTS.TOOL_RUN, label: 'Ran a tool', by: 'tool' };
