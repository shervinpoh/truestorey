  ...
  },
  {
    ...
    items: [
      ...
      { href: '/blindspot', label: 'Blindspot', match: ['/blindspot'], home: true,
        blurb: 'Five checks against filed transactions, scored to a published rubric',
        ...
        get: 'Five checks against filed public records, scored by a formula published on the page. Never a valuation.' },
