...
export const NAV = [
  {
    ...
    items: [
      ...
      /* Its own run: a school is not a place to price, and "Look up a place"
         holds four already — the most one run may offer. */
      { href: '/schools', label: 'Primary schools', match: ['/schools'], sub: 'For families',
        blurb: 'How far each school’s P1 places reached, and the homes nearby',
        plain: 'How hard was this primary school to get into, and what is there to live near it?',
        get: 'Every primary school, how far its places reached in MOE’s latest exercise, in MOE’s words, and the homes within 1 and 2 km.' },
    ],
  },
  {
    group: 'Tools',
    ...
    items: [
      ...
      { href: '/sun', label: 'Sun on a window', match: ['/sun'],
        blurb: 'Direct sun on one window, month by hour, with the buildings in the way',
        plain: 'How much sun will this window get, and when?',
        use: 'Before you choose a floor or a facing — the west sun question, answered for one window.',
        need: 'A block or project, then a floor and the way the window faces.',
        get: 'Minutes of direct sun on that window for every month and hour, with the neighbouring blocks that shade it.' },
...
export const TOOL_GROUPS = [
  ...
  { label: 'Checking a home', items: [
    ...
    { href: '/sun', icon: 'sun', name: 'Sun on a window', note: 'Direct sun by month and hour, blocks in the way' },
  ] },
...
export const ICON_FOR = {
  ...
  '/insights': 'pen', '/guides': 'book', '/schools': 'book', '/archive': 'book', '/about': 'home', '/refused': 'check',
...
export const FINDABLE = [
  ...
  { href: '/schools', icon: 'book', name: 'Primary schools', note: 'How far P1 places reached, and the homes nearby', group: 'Look up' },
...
const WORDS = {
  ...
  '/sun': 'sun sunlight west sun afternoon heat facing shadow shade window orientation east morning',
  '/schools': 'school schools primary p1 ballot balloting phase 2c 2b 2a 1km 2km moe registration near',
