...
export const SITUATIONS = [
  ...
  },
  {
    ...
    primary: ['/cost', '/tools?calc=sell', '/mop'],
...
export const TOOL_GROUPS = [
  { label: 'Before you buy', items: [
    ...
    { href: '/tools?calc=duty', icon: 'stamp', name: 'Stamp duty on a price', note: 'Both buyer’s duties, band by band' },
  ] },
  { label: 'Checking a home', items: [
    ...
    { href: '/floorplan', icon: 'plan', name: 'Read a floor plan', note: 'Usable area, and the walls to ask about' },
  ] },
  { label: 'Owning and selling', items: [
    { href: '/tools?calc=sell', icon: 'calendar', name: 'When can I sell?', note: 'Your minimum occupation and seller’s duty dates' },
  ...
  { label: 'Market and land', items: [
    { href: '/map', icon: 'map', name: 'The price map', note: 'Every block and project, by filed median psf' },
...
const WORDS = {
  ...
  '/tools?calc=duty': 'stamp duty bsd absd buyer additional tax iras second property',
  ...
  '/tools?calc=sell': 'sell selling when can i sell mop ssd seller stamp duty minimum occupation date',
