...
import { supplyWithin, priceAnalysis, glsWithin, plotRatioWithin, approvalsWithin, leaseFinding, liquidityFinding } from './measure.js';
...
export function analyse({ href, askPrice = null, areaSqft = null, floor = null, now = new Date() } = {}) {
  ...
  return {
    ...
    ...result,
    detail: { price, lease, liquidity, supply, gls, view, zoning },
