...
export function analyse({ href, askPrice = null, areaSqft = null, floor = null, now = new Date() } = {}) {
  ...
  const result = score({
    ...
    // rubric exists to prevent. It is skipped now and says why; the
    ...
    supply: rec.kind === 'HDB' ? supply : {
      ...supply,
      unavailable: 'This measures flats reaching their fifth year nearby — who else will be '
                 + 'selling, if what you are selling is a flat. It is not a measure of supply '
                 + 'in the private market and is not scored here.',
    },
    gls,
