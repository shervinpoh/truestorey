 ...
 */
export function analyse({ href, askPrice = null, areaSqft = null, floor = null, now = new Date() } = {}) {
  ...
  const price = askingPsf ? priceAnalysis(rec, askingPsf, { areaSqft, floor, now }) : null;
  ...
  return {
    ...
    input: { askPrice: askPrice ? Number(askPrice) : null, areaSqft: areaSqft ? Number(areaSqft) : null, floor: floor ? Number(floor) : null, askingPsf: askingPsf ? Math.round(askingPsf) : null },
    ...result,
