...
export const CHECKS = {
  ...
  gls: {
    ...
    needs: 'The GLS programme — NOT in the repo yet. Run `npm run ingest:gls`.',
  ...
  view: {
    ...
    needs: 'Master Plan land use and plot ratio — NOT in the repo yet. Run `npm run ingest:zoning`.',
