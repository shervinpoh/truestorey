...
export const CHECKS = {
  ...
  gls: {
    ...
    caveat: (_u, c) => {
      ...
      if (c.gfaSqm) bits.push(`${c.gfaSqm.toLocaleString('en-SG')} sqm of gross floor area is zoned across the GLS sites in this radius — URA publishes no unit yield for them`);
