...
export function withEditorialAsset(post) {
  if (!post) return post;
  /* A photograph of the place the piece is about outranks any illustration
     of its topic. The illustrations stood in for stock photographs of
     objects; they were never meant to cover a real photograph of Bedok. */
